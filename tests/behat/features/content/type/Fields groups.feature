Feature: Fields groups
  ...
  Scenario: I can sort field groups
    Given I have ContentType named "Content type", with code "content_type", with type "node"
    ...
    When I sort fields groups to new order "group_code_1,group_code_2,group_code_3"
    Then fields groups should be in order "group_code_1,group_code_2,group_code_3"
    When I sort fields groups to new order "group_code_2,group_code_3,group_code_1"
    Then fields groups should be in order "group_code_2,group_code_3,group_code_1"
