...
<body class="d-flex h-100 text-center text-bg-dark">
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main class="px-3">
            ...
            <p><?php echo sprintf('Cannot find website for path "%s" and domain "%s"', $path, $host); ?></p>
            ...
            <p>
                ...
                <br />3. Check if website is path prefix and locale prefix are set properly and exists in requested URL (<code><?= $path ?></code>)
            </p>
        </main>
