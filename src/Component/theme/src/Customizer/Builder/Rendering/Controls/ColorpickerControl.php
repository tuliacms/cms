 ...
 */
class ColorpickerControl extends AbstractControl
{
    public function build(array $params): string
    {
        return '<div class="form-group mb-3' . ($params['is_multilingual'] ? ' form-group-multilingual' : '') . '">
            ...
            <input type="color" id="' . $params['control_id'] . '" name="' . $params['control_name'] . '" class="customizer-control form-control" value="' . $this->escapeAttribute($params['value']) . '" data-transport="' . $params['transport'] . '" />
        </div>';
    }
