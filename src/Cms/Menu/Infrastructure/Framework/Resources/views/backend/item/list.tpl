    ...
    <div class="pane pane-lead">
        <div class="pane-header">
            <div class="pane-buttons">
                <a href="{{ path('backend.menu.item.hierarchy', { menuId: menu.id }) }}" class="btn btn-secondary btn-icon-only" title="{{ 'changeHierarchy'|trans({}, 'menu') }}" data-bs-toggle="tooltip"><i class="btn-icon fa fa-sitemap"></i></a>
