...
<script setup>
import Sizer from "admin/Canvas/Sizer.vue";
import DeviceFaker from "admin/Canvas/DeviceFaker.vue";
import { defineProps, computed, inject } from "vue";

const props = defineProps(['canvasOptions']);
