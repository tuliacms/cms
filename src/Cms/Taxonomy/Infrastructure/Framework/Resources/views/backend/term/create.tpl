    ...
    <div class="pane pane-lead">
        <div class="pane-header">
            <div class="pane-buttons">
                <a href="{{ path('backend.term', { taxonomyType: taxonomyType }) }}" class="btn btn-secondary btn-icon-only" data-bs-toggle="tooltip" title="{{ 'cancel'|trans({}, 'messages') }}"><i class="btn-icon fas fa-times"></i></a>
