...
class DatabaseStorage implements StorageInterface
{
    ...
    {
        $this->connection->executeStatement('INSERT INTO #__customizer_changeset
            (id, theme, type, created_at, updated_at, payload, website_id)
            SELECT :newId AS id, theme, `type`, created_at, updated_at, payload, website_id
        ...
        $this->connection->executeStatement('INSERT INTO #__customizer_changeset_lang
