            ...
            <div class="pane-buttons">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-left">
                        ...
                        {% endfor %}#}
                        <a class="dropdown-item dropdown-item-with-icon" href="{{ path('backend.settings', { group: 'tulia_node_' ~ nodeType.code }) }}"><i class="dropdown-icon fas fa-cogs"></i> {{ 'settings'|trans({}, 'messages') }}</a>
                    </div>
                </div>
